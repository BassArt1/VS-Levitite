...
class ModItems {
    companion object{
        ...
        var LEVITITE_CORE: RegistrySupplier<Item> = ITEMS.register(ResourceLocation(VSLevititeMod.MOD_ID, "levitite_core"),
            { Item(Item.Properties().`arch$tab`(ModCreativeTab.LEVITITE_TAB)) } )

        var LEVITITE_ENGINE: RegistrySupplier<Item> = ITEMS.register(ResourceLocation(VSLevititeMod.MOD_ID, "levitite_engine"),
